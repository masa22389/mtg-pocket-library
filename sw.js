const CACHE = "mtg-pocket-v231";
const OFFLINE_PAGE = "./index.html?v=231";
const SHELL = [OFFLINE_PAGE, "./styles.css?v=231", "./mtg-jp-card-index.js?v=231", "./mtgjson-jp-search-index.js?v=231", "./app.js?v=231", "./manifest.webmanifest", "./icons/icon-192.png", "./icons/icon-512.png", "./icons/icon-maskable-512.png"];
